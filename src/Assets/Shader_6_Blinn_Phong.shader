...
//                half3 specular = LightingSpecular(light.color, light.direction, normal, view_direction,
//                    _SpecularIntensity, _SpecularPower);

                half3 color = light.color * (
                    specular
                    + (1 -_AmbientRate) * lambert
                    + _AmbientRate * ambient);
