...
//                half F = FresnelReflectanceAverageDielectric(VdotN, _Fresnel0);// S”gP”g•½‹Ï‚Ì–³‹ßŽ—
//                half F = _Fresnel0 + (1-_Fresnel0) * pow(1 - VdotN, 5);// Schlick‹ßŽ—
                half F = _Fresnel0 + (1-_Fresnel0) * exp(-6 * VdotN);// FarCry3‹ßŽ—
